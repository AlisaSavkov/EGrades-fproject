...
class StudentGrade extends Component {
  ...
  handleSearchValue = event => {
    ...
    //     this.setState({ searchedMarkValue: event.target.value, errorMessage: "" });
    // }
    else {this.setState({ searchedMarkValue: event.target.value, errorMessage: "Grade can be between 1 and 5!" });}
  ...
  componentDidMount() {
    ...
    const selectedStudent = localStorage.getItem("id");
      ...
      <div>
        ...
        {this.state.student && (
          <div className="card">
            ...
            <p className="title1">Class: {this.state.student.ClassYear} - {this.state.student.ClassLabel}</p>
          </div>
        )}
                  ...
                  .filter(
                    grade =>
                      (this.state.searchedMarkValue === "" &&
                        ...
                        this.state.searchedTeacherValue === grade.TeacherLastName) 
                        ||
